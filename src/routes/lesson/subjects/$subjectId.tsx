...
import type { Topic } from "@/common/types/curriculum.types";
...
function SubjectDetailComponent() {
  ...
  return (
    <div className="min-h-screen pb-20 font-sans bg-white text-black">
      ...
      <div
        className="p-6 md:p-10 border-b bg-gray-50"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2 text-black">{subjectName}</h1>
                ...
                <div
                  ...
                  <div className="flex flex-wrap gap-4 mt-auto pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-1.5 text-xs font-medium text-gray-500">
                      ...
                      <span>
                        {Math.max(0, topic.performanceObjectives.length - 1)}{" "}
                        Objectives
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5 text-xs font-medium text-gray-500">
